...
function crearFormulario() {
 /************************************************************************************
 *                     Plantilla de formulario de DA                              * 
 * https://docs.google.com/forms/d/1EDUFr4PwrQoXttU7WPEQzZG60s3gDQ4evBhE_TnYDfM/edit *
 *************************************************************************************/  
   var formulario = DriveApp.getFileById('1EDUFr4PwrQoXttU7WPEQzZG60s3gDQ4evBhE_TnYDfM').makeCopy('Cuestionario Alumnos Data Analyst',DriveApp.getRootFolder()); 
