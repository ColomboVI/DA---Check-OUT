...
function Comunicaciones() {
  ...
  **********************/
  this.mandarfeedback = function (mails_destinatarios, formulario) {
   ...
   //Mandar mensaje checkin
    this.mandarCheckIn=function (mails_destinatarios,formulario)
    {
        ...
        this._enviarMailDesdeBuzonPersonal(mails_destinatarios.join(','), this._mensajes.getAsuntoEmail()+' | Check-in',options, text);
  }
